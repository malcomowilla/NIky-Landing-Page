...
<footer className="max-container bg-black h-[600px]  max-lg:h-[800px]  max-sm:h-[1000px]  ">
...
<a href="/"> <img src={footerLogo} width={150} height={46}/>
...
<ul>{section.links.map(link=> {
  return <li key={link.name} className="mt-3 text-white-400
  
  font-montserrat text-base leading-normal hover:text-blue-700
  cursor-pointer
...
<p className="font-monseratt  cursor-pointer
